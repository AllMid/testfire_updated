...
def test_sql_injections_field(browser, url_address, username, password):
    ...
    go_to_login_page = BrowserPage()
    go_to_login_page.go_to_site(browser, url_address)
...
def test_sql_injections_search(browser, url_address):
...
def test_xss_injections_field(browser, url_address, username, password):
    logging.info(f'Start Test with {username} and {password} in form')
    auth_page = Login_page('login_page', Login_page.LOCATOR_LOGIN_BUTTON)
    go_to_login_page = BrowserPage()
    go_to_login_page.go_to_site(browser, url_address)
...
def test_xss_injections_search(browser, url_address):
